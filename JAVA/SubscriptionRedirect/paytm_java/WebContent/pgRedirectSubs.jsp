...
parameters.put("REQUEST_TYPE","SUBSCRIBE");
...
parameters.put("SUBS_EXPIRY_DATE","2017-04-17 16:19:30.396"); // Must be grater than last insatllment date
parameters.put("SUBS_ENABLE_RETRY","0"); 
parameters.put("SUBS_PPI_ONLY","Y"); 
parameters.put("SUBS_FREQUENCY_UNIT","MONTH"); // DAY / MONTH / YEAR
parameters.put("SUBS_AMOUNT_TYPE","FIX"); // FIX / VARIABLE
parameters.put("SUBS_SERVICE_ID","10981771");
parameters.put("SUBS_FREQUENCY","1");
